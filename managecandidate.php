...
<table class="table table-hover">
                                        ...
                                        while( $row=mysqli_fetch_row($rs))
                                        {
                                            ...
                                            {
                                              if($i==$count)
                                                echo "<td><form action='updatecandidate.php' > <input type='hidden' name='update' value='$row[0]' />   <input type='submit'  value='update' class='active btn btn-info' /> </form></td>";

                                            else if($i==$count+1)
                                                echo "<td> <form action='deletecandidate.php'  > <input type='hidden' name='delete' value='$row[0]' /><input type='submit' value='delete' class='active btn btn-info' /></form></td>";
