...
$conn= @mysqli_connect($host,$user,$pass,$db) or die("Can't connect to database");
    ...
    $qry="Select * from candidate_reg order by c_id";
...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <img src="images/info.jpg" width="1350" height="300" alt="" class="hbgimg" />
      </div>
      </div>
        </div>
        </fieldset>
                    ...
                    <a class="dropdown-toggle" data-toggle="dropdown" href="candidate.php">
                        <i class="fa fa-bar-chart-o fa-fw"></i>Candidate<span class="fa arrow"></span></a>
                            <ul class="dropdown-menu dropdown-candidate">
                                ...
                                <li>
                                    <a href="candidatelogin.php">Candidate Registration</a>
                                </li>
                                <li>
                    ...
                    <a class="dropdown-toggle" data-toggle="dropdown" href="admin.php">
                        <i class="fa fa-bar-chart-o fa-fw"></i>Administrator<span class="fa arrow"></span></a>
                            <ul class="dropdown-menu dropdown-Administrator">
                                ...
                                <li>
                                    <a href="adminlogin.php">Manage User/Candidate Account</a>
                                </li>
                                <li>
                                    <a href="adminlogin.php">Approve Applicants(voter)</a>
                                </li>
                                <li>
                                    <a href="adminlogin.php">Open Candidate Account</a>
                                </li>
                                <li>
                                    <a href="adminlogin.php">Registration of Parties</a>
                                </li>
                                <li>
                                    <a href="adminlogin.php">Mark Voted and generate password</a>
                                </li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Voter Panel</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
...
<legend>Manage Candidate account</legend>
