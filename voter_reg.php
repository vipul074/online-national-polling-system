...
<head>
    ...
    <title>ONPS|Voter Registration</title>
    ...
    <div class="header_resize">
      <img src="images/onlinregistration.jpg" width="1350" height="300" alt="" class="hbgimg" />
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Voter Registration</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div id="page-wrapper" style="background-color: blanchedalmond;">
            <div class="row">
                <div class="col-lg-12">
...
<div class="col-lg-7">
                          <section class="panel">
                              <header class="panel-heading" style="background-color:whitesmoke;">
                              Registration Form
                              </header>
...
if(isset($_POST['sbt95']))
{
  ...
  $query="insert into voter_reg values('$voter_id','$first_name','$last_name','$father_name','$Dob','$state','$city','$address','$e_mail','$contact_no','$pin_code',
