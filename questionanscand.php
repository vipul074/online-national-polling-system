...
<head>
    ...
    <title>ONPS|candidate|Question/Ans</title>
...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <img src="images/Q&A.jpg" width="1350" height="300" alt="" class="hbgimg" />
      </div>
      </div>
        </div>
        </fieldset>
                ...
                <div class="sidebar-nav navbar-collapse">
                    ...
                    <a class="dropdown-toggle" data-toggle="dropdown" href="candidatelogin.php">
                        <i class="fa fa-bar-chart-o fa-fw"></i>Candidate<span class="fa arrow"></span></a>
                            ...
                            <li> <a href="candidate_reg.php">Candidate Registration</a>
                                </li>
                                <li>
   ...
   <li>
                    ...
                    <a href="adminlogin.php">
                        <i class="fa fa-bar-chart-o fa-fw"></i>Administrator<span class="fa arrow"></a>
        ...
        <div id="page-wrapper" style="background-color:lightslategrey;">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">QUESTION/ANSWER</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
...
<?php
$query="select Question from questionask";
...
<tr><td>Answer The Above Question</td></tr><tr></tr><td><textarea name="answered" rows="20" cols="30" required="true" placeholder="Enter Answer"oninvalid="setcustomvalidity(don't leave filed blank)" oninput="setcustomvalidity"></textarea></td></tr>
...
<center><button type="submit" name="sbt3" class="btn btn-info">Submit</button>&nbsp;</center>
<br />
...
{ 
    ...
    $querya="insert into questionask value('$answered')";
