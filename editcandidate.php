...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <img src="images/edit.png" width="1350" height="300" alt="" class="hbgimg" />
      </div>
      </div>
        </div>
        </fieldset>
...
<div class="col-lg-7">
                          <section class="panel">
                              <header class="panel-heading" style="background-color: dimgray;">
                              Edit profile Form
                              </header>
...
<input type="text" name="c_id" required="true" class="form-control" id="exampleInputText11" placeholder="Enter candidate id" oninvalid="setcustomvalidity(don't leave filed blank)" oninput="setcustomvalidity" />
...
if(isset($_POST['sbt17']))
{
  ...
  $query="update candidate_reg values('$c_id','$firstname','$lastname','$fathername','$Dob','$state','$city','$party','$photo','$email','$address','$contactno','$username','$password','$election_reason','$v_id')";
