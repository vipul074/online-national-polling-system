...
<table class="table table-hover">
                                        ...
                                        while( $row=mysqli_fetch_row($rs))
                                        {
                                            ...
                                            if($i==$count)
                                                echo "<td> <form> <input type='hidden' name='open_account' value='$row[0]' /><input type='submit' value='open account' class='active btn btn-info' /></form></td>";
