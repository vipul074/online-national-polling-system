...
<head>
    ...
    <title>ONPS|voter|Question/Ans</title>
...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <img src="images/questions.jpg" width="1350" height="300" alt="" class="hbgimg" />
      </div>
      </div>
        </div>
        </fieldset>
...
<tr><td>Post Your Question Which You Want To Ask</td></tr><tr></tr><td><textarea name="Question" rows="10" cols="100" required="true" placeholder="Enter Question"oninvalid="setcustomvalidity(don't leave filed blank)" oninput="setcustomvalidity"></textarea></td></tr>
...
{ 
  ...
  $img=addslashes($tfile);
    ...
    $query="insert into questionask value('$Question')";
  mysqli_query($link,$query);
  echo "<script>alert('Question posted to candidate')</script>";
