...
<table class="table table-hover">
                                        ...
                                        while( $row=mysqli_fetch_row($rs))
                                        {
                                            ...
                                            {
                                              if($i==$count)
                                                echo "<td><form> <input type='hidden' name='update' value='$row[0]' />   <input type='checkbox'  value='Remember Me' class='active btn btn-info' /> </form></td>";
                                        ...
                                        ?>
                                          ...
                                          <button type="submit" name="mark" class="btn btn-danger btn-success btn-block">Mark Voted</button>
