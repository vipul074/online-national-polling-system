...
$conn= @mysqli_connect($host,$user,$pass,$db) or die("Can't connect to database");
    ...
    $qry="Select * from voter_reg order by voter_id";
...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <img src="images/approved.png" width="1350" height="350" alt="" class="hbgimg" />
      </div>
      </div>
        </div>
        </fieldset>
...
<legend>Approve Voters</legend>
<table class="table table-hover">
                                        <tr><th><input name="remember" type="checkbox" value="select all"/>select all</th>
                                            <th>Voter_ID</th>
                                            <th>First Name</th>
                                            <th>Last Name</th>
                                            <th>Father Name</th>
...
<center><button type="submit" name="approve" class="btn btn-info">Approve</button>&nbsp;</center>
...
$FirstName=$_POST['FirstName'];
  ...
  $query="insert into approved voters values('$Voter_id','$FirstName','$LastName','$FatherName','$DOB','$state','$city','$Address','$Email','$ContactNumber'
  ,'$PinCode')";
