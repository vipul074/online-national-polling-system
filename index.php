...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <img src="images/logo.jpg" width="1350" height="300" alt="" class="hbgimg" />
      </div>
      </div>
        </div>
        </fieldset>
                ...
                <div class="sidebar-nav navbar-collapse">
                    ...
                    <a href="adminlogin.php">
                        <i class="fa fa-bar-chart-o fa-fw"></i>Administrator<span class="fa arrow"></span></a>
                                ...
                                <!--/about us-->
                                <li><a href="aboutus.php"><i class="fa fa-bar-chart-o fa-fw"></i> About Us<span class="fa arrow"></span></a>
                                </li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">ONPS HOME</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div id="page-wrapper">
            <div class="row">
                ...
                <div>
                <legend>what is a candidate ?</legend>
                <fieldset>
...
However, this definition does not include any candidate for a political party executive committee.<br />
<br />
</fieldset>

</div><br />
<div><fieldset>
<legend>who can be a voter ?</legend>                
                A Voter Is
